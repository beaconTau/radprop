/**
 * This file has been modified for radprop from SPLAT v.1.4.2.  See the original note below.
 *
 *  Changes for radprop:
 *
 *   staticifying most methods not intended to be public. 
 */
...
*****************************************************************************/
{
	...
	prop.encc = clutter_refractivity;		/*  double enc_ncc_clcref preset  */          	
	prop.cch = clutter_height; 		/* double clutter_height preset to ILLR calibration.;  
					   use 25.3 for ITU-P1546-2 calibration */	
	prop.cd = clutter_density;                 /* double clutter_density preset */ 
	//int mode_var = 1; 		/* int mode_var set to 1 for FCC compatibility;
  //				   normally, SPLAT presets this to 12 */
	prop.dhd= delta_h_diff;			/* delta_h_diff preset */
